...
const ContactUs = () => {
  ...
  return (
    ...
    >
      ...
      {/* Contact Form */}
      <div className="relative z-10 bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg p-10 max-w-lg w-full transform transition duration-500 hover:scale-105">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block mb-2 text-gray-700">Your Query</label>
            <textarea
              name="query"
